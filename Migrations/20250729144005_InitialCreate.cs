...
namespace IdentityAppV2.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTokenMaps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserTokenMaps_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserTokenMaps_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_ExternalId_ExternalProvider",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomUserClaims_UserId_ClaimType",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTokenMaps_ApplicationId",
                table: "UserTokenMaps",
                column: "ApplicationId");

            migrationBuilder.CreateIndex(
                name: "IX_UserTokenMaps_RefreshToken",
                table: "UserTokenMaps",
                column: "RefreshToken",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserTokenMaps_UserId_ApplicationId",
                table: "UserTokenMaps",
